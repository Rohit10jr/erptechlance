...
class ledger_balance(models.Model):
    ...
    fc_amount = models.DecimalField(max_digits=100, decimal_places=2, defualt=0)
    fc_name = models.DecimalField(max_digits=100, decimal_places=2, default=0)
...
class ledger_bal_billwise(models.Model):
    ledger_bal_id = models.ForeignKey(to=ledger_balance, related_name="ledger_bal_billwise", null=False, on_delete=models.PROTETCT)
    company_master_id = models.ForeignKey(to=company_master, unll=False, on_delte=models.PROTECT)
